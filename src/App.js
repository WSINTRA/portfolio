  ...
  return (
    <>
      <div>
        ...
        <p style={{paddingLeft: "1rem", paddingTop: '1rem'}}className="monospace">
          Life is a long and exciting journey, We leave school/education hoping
          to meet the the world and find a place in it.
          <br />
          ...
          Eventually transitioning from telecommunications engineering to youth
          work and education. <br />A musician with a love for the community.{" "}
          <a
            target="_blank"
            rel="noopener noreferrer"
          ...
          Here I reconnected with my nerdy teenage self and re-introduced myself
          into a world of technology and software development. <br />
          <br />A lot of self study and some community volunteering kept me busy
          before beginning the in-campus Full-Stack Engineering bootcamp at the
          Flatiron School in Brooklyn DUMBO. I love software development,
          discovering and thinking about how all the complex pieces of the
          system fit together. <br />
          ...
          many experiences to the projects I am engaged in. Some of the newer
          technologies I am getting to grips with include GoLang, GraphQL,
          Prisma, React Native and Apollo. <br />
      ...
      <div className="w3-quarter" style={{borderLeft: 'solid'}}>
        ...
        >
          <div className="contact-box" id="connect">
            ...
            <p className="contact-box__text">
              <i>"Music Saves The World YouTube channel (projects I worked on)"</i>
            </p>
          </div>
        </a>
        <a
